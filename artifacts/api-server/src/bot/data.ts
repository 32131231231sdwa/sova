...
export const OWL_WISE_QUOTES = [
  "Не тревожь меня — я думаю о вечном.",
  "Мудрость приходит не со временем, а с тишиной.",
  "Кто спрашивает — тот уже знает половину ответа.",
  "Луна светит всем, но видят её немногие.",
  "Ветер не спрашивает разрешения. И я тоже.",
  "Терпение — это молчаливое знание.",
  "Лес старше тебя. Прислушайся к нему.",
  "Не все совы молчат из скромности.",
  "Ночь лучше знает правду, чем день.",
  "Иногда лучший ответ — пристальный взгляд.",
  "Я видел рассветы, которые тебе не снились.",
  "Дерево стоит тысячу лет, потому что не торопится.",
  "Угу — это мой ответ на всё.",
  "Мышь думает, что она незаметна. Смешно.",
  "Тот, кто смотрит вниз, не видит звёзд.",
];
